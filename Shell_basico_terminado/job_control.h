...
enum job_state { FOREGROUND, BACKGROUND, STOPPED, CONTINUED };
static char* status_strings[] = { "Suspended","Signaled","Exited","Continued"};
static char* state_strings[] = { "Foreground","Background","Stopped", "Continued" };
...
typedef struct job_
{
	...
	struct termios atrib; //atributos del terminal
} job;
